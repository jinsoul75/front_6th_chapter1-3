...
import { clearCart, deselectAllCart, removeSelectedFromCart, selectAllCart } from "../cartUseCase";
...
const checkout = () => showToast("구매 기능은 추후 구현 예정입니다.", "info");
      ...
      <div className="flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4">
        <div className="relative bg-white rounded-t-lg sm:rounded-lg shadow-xl w-full max-w-md sm:max-w-lg max-h-[90vh] overflow-hidden">
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 p-4 flex items-center justify-between">
            ...
            <button id="cart-modal-close-btn" className="text-gray-400 hover:text-gray-600 p-1" onClick={closeModal}>
